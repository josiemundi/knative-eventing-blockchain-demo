...
func display(event cloudevents.Event, response *cloudevents.EventResponse) {
	...
	newEvent.SetSource(fmt.Sprintf("https://knative.dev/josiemundi/transactionClassified"))
	newEvent.SetType("dev.knative.eventing.josiemundi.transaction.classify")
	newEvent.SetID("1234")
