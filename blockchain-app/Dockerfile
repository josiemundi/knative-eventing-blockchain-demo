...
WORKDIR /go/src/github.com/josiemundi/knative-eventing-websocket-source
COPY . .
...
COPY --from=builder /go/src/github.com/josiemundi/knative-eventing-websocket-source/wseventsource /wseventsource
